...
**Improved Concurrency:** Probuster is now improved more powerfull in concurrency and this particular improvement made in Directory/File Enumeration Mode which probuster now can run efficiently run in low end system with high concurrency and also improved resulting accuracy.
